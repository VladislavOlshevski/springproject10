...
//
//import by.vlad.springproject1.dto.NewActivityDto;
...
//    private final TaskRepository taskRepository;private final RoleService roleService;
//    private TaskService taskService;
//    private final UserService userService;
//    private final ProjectService projectService;
//    @Autowired
//    public ActivityService(ActivityRepository activityRepository, RoleService
//            roleService, UserService userService, TaskRepository taskRepository,
...
//    }
//    public Activity get(User user, Long activityId) throws
//            NoSuchEntityException, AuthorizationException {
//        Activity activity =
//                activityRepository.findById(activityId).orElseThrow(() -> new
//                        NoSuchEntityException("no such activity"));
//        roleService.authorize(user, activity.getTask().getProject(), UserRole.VIEWER);
//        return activity;
//    }
//    public Activity create(User user, NewActivityDto newActivityDto) throws
//            NoSuchEntityException, AuthorizationException {
//        if (newActivityDto.status == null && newActivityDto.elapsed == null &&
//                newActivityDto.assigneeLogin == null)
...
//                NoSuchEntityException("no such task"));
//        roleService.authorize(user, task.getProject(), UserRole.VIEWER);
//        return activityRepository.findAllByTask(task, pageable);
//    }
//    public List<Activity> allByProject(User user, Long projectId, Pageable
//            pageable) throws AuthorizationException, NoSuchEntityException {
//        Project project = projectService.get(user, projectId);
//        return activityRepository.findAllByProject(project, pageable);
//    }
//    public void delete(User user, Long activityId) throws
//            NoSuchEntityException, AuthorizationException {
//        Activity activity =
//                activityRepository.findById(activityId).orElseThrow(() -> new
//                        NoSuchEntityException("no such activity"));
//        if (!(roleService.hasPermission(user, activity.getTask().getProject(),
